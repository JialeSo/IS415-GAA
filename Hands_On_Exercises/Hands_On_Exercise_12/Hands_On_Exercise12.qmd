---
title: "Hands-On Exercise 12 Calibrating Hedonic Pricing Model for Private Highrise Property with GWR Method" 
author: "Jiale SO"
...
## **12.4 A short note about GWmodel**
...
## **12.5 Geospatial Data Wrangling**

### **12.5.1 Importing geospatial data**
...
### **12.5.2 Updating CRS information**
...
## **12.6 Aspatial Data Wrangling**

### **12.6.1 Importing the aspatial data**
...
### **12.6.2 Converting aspatial data frame into a sf object**
...
### **12.7.1 EDA using statistical graphics**
...
### **12.7.2 Multiple Histogram Plots distribution of variables**
...
### **12.7.3 Drawing Statistical Point Map**
...
`set.zoom.limits` argument of `tm_view()` sets the minimum and maximum zoom level to 12 and 14 respectively.
...
## **12.8 Hedonic Pricing Modelling in R**
...
### **12..8.1 Simple Linear Regression Method**
...
### **12.8.2 Multiple Linear Regression Method**

#### 12.8.2.1 Visualising the relationships of the independent variables
...
### **12.8.3 Building a hedonic pricing model using multiple linear regression method**
...
### **12.8.4 Preparing Publication Quality Table: olsrr method**
...
### **12.8.5 Preparing Publication Quality Table: gtsummary method**
...
#### 12.8.5.1 Checking for multicolinearity
...
#### 12.8.5.2 Test for Non-Linearity
...
#### 12.8.5.3 Test for Normality Assumption
...
#### 12.8.5.4 Testing for Spatial Autocorrelation
...
## **12.9 Building Hedonic Pricing Models using GWmodel**
...
### **12.9.1 Building Fixed Bandwidth GWR Model**

#### 12.9.1.1 Computing fixed bandwith
...
The bandwidth here is in meters because we specified `longlat = FALSE` in the `bw.gwr` function call. Setting `longlat = FALSE` assumes the coordinates are projected (e.g., using a metric projection like UTM) rather than in geographic coordinates (longitude and latitude), which would be measured in degrees.
:::

#### 12.9.1.2 GWModel method - fixed bandwith
...
### **12.9.2 Building Adaptive Bandwidth GWR Model**

In this section, we will calibrate the gwr-based hedonic pricing model by using adaptive bandwidth approach.

#### 12.9.2.1 Computing the adaptive bandwidth
...
#### 12.9.2.2 Constructing the adaptive bandwidth gwr model
...
### **12.9.4 Converting SDF into *sf* data.frame**
